...
class StandardScaler:
    ...
    When transforming a dataset, the StandardScaler subtracts the means and
    divides by the standard deviations.
    """
    ...
    def transform(self, X: List[List[float]]):
        ...
        transformed_with_none = np.where(
            np.isnan(transformed_with_nan), self.replace_nan_token,
